...
class NwbRecordingExtractor(BaseRecording):
    ...
    file_path : str, Path or None
        ...
        if not using the `file` or `h5py_file` parameter.
    ...
    h5py_file : h5py.File or None, default: None
        A h5py.File-like object representing the NWB file. (jfm)
    cache : bool, default: False
    ...
    def __init__(
        ...
        *,
        ...
        if h5py_file is not None:
            # not json serializable if h5py_file arg is provided
            self._serializability["json"] = False
