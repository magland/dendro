...
const ComputeClientNameComponent: FunctionComponent<ComputeClientNameComponentProps> = ({ computeClientId, computeClientName }) => {
    ...
    return (
        <Hyperlink
            ...
            color='#552'
        >{computeClientNameDisplay}</Hyperlink>
    )
}
